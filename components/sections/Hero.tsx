      ...
      <div className="relative mx-auto max-w-6xl px-6 pb-24 pt-20 sm:pb-32 sm:pt-28">
        <div className="animate-fade-in flex items-center gap-3">
          <Image
            ...
            width={28}
            height={28}
            className="h-7 w-7 flex-none transition-transform duration-700 ease-out hover:rotate-[360deg]"
          />
        ...
        <h1 className="animate-fade-up font-display mt-7 max-w-3xl text-balance text-[2.75rem] font-medium leading-[1.08] text-ivory sm:text-6xl lg:text-[4.5rem]">
        ...
        >
          MIHN is an institutional home for certification in human
          performance, sports nutrition, fitness coaching and clinical
          supplementation — built as a growing academy, not a single course.
        </p>
