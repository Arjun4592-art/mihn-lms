        ...
        <div className="grid gap-14 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="space-y-6 font-sans text-base leading-relaxed text-ink-soft">
            <p>
              ...
              formality at the end of it. Candidates are evaluated on
              applied competence — case-based scenarios and practical
              demonstration, not memorisation alone.
            </p>
            <p>
              A pass reflects readiness to practise, not just attendance.
              Where a program includes a practical component, that
              component is weighted at least as heavily as written
              assessment, and reviewed by faculty independent of instruction.
            </p>
